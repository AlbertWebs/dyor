        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> IRL</a>
                    </li>
                    <li class="page-back"><a href="{{url('/')}}/admin/addMeetup"><i class="fa fa-pencil" aria-hidden="true"></i> Add IRL Post</a>
                    </li>
                </ul>
            </div>
            <div class="sb2-2-1">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('/')}}/admin/editIRL/{{$item->id}}" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            </td>
