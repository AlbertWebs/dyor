...
<head>
    ...
    @vite(['resources/sass/upload.scss', 'resources/js/app.js'])
</head>
<body>
    ...
    <section class="py-5">
        <div class="container py-5">
            <header class="mb-5">
                <h1 class="display-5 fw-bold mb-4">{{$LastMeetup->title}} Dropzone image uploads </h1>
            ...
            <form id="dzImageUploadForm" action="/upload" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="meetupid" vakue="{{$LastMeetup->id}}">
